...
export declare const component: {
    ...
    <Data, Methods, Computed, Props, PropsDef extends RecordPropsDefinition<Props>, RequiredProps extends keyof Props = { [K in keyof PropsDef]: PropsDef[K] extends {
        required: true;
    } ? K : never; }[Extract<keyof PropsDef, string>] & keyof Props>(options: object & ComponentOptions<Vue, Data | ((this: Readonly<Props> & Vue) => Data), Methods, Computed, RecordPropsDefinition<Props>> & ThisType<Data & Methods & Computed & Readonly<Props> & Vue> & {
